    ...
    <div>
      <section id="hero" className="relative h-screen overflow-hidden">
        ...
        <SplitText
          ...
          <p className="text-white md:text-xl text-sm font-medium pt-6">{t('home.hero.paragraph')}</p>
          <div className="flex md:flex-row flex-col gap-5 md:gap-10 py-10">
            <Link to="/about" className="bg-green-700 border border-green-700 font-semibold text-lg hover:bg-white hover:text-green-700 text-white px-4 py-2 rounded-sm transition-colors duration-300 shadow cursor-pointer">
              <button className="cursor-pointer">
              {t('home.hero.buttons.learnMore')}
            </button>
            </Link>
            <Link to="/services" className="bg-white border border-green-700 font-semibold text-lg hover:bg-green-700 hover:text-white text-green-700 px-4 py-2 rounded-sm transition-colors duration-300 shadow cursor-pointer">
            <button className="cursor-pointer">
              {t('home.hero.buttons.viewServices')}
            </button>
            </Link>
          </div>
        </div>
