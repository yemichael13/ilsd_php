...
const Our_Team = () => {
  ...
  const teamMembers = [
    { name: "Some Name", position: "CEO" },
    { name: "Another Name", position: "Position" },
    { name: "Yet Another Name", position: "Position" },
    { name: "One More Name", position: "Position" },
    { name: "Last Name", position: "Position" },
  ];
  ...
  return (
    <div className="md:p-10 flex flex-col items-center justify-center">
      ...
      <p className="my-5 px-6 text-center max-w-4xl mx-auto">
        Our team brings together young innovators, agricultural experts, and technology professionals who share the same goal.
      </p>
